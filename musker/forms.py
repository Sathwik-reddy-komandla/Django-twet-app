...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.fields['password1'].help_text='<span class="form-text text-muted"><small>Your password cannot ne similar to aother personal information.<small></span>'

        self.fields['password2'].widget.attrs['class']='form-control'
        self.fields['password2'].widget.attrs['placeholder']='Confirm Password'
        self.fields['password2'].label=''
        self.fields['password2'].help_text='<span class="form-text text-muted"><small>Enter the same password you have entered above.</small></span>'
